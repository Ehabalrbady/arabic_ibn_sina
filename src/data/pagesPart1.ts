...
export const PAGES_PART_1: BookPage[] = [
  ...
  // Page 6: Letters Vowels
  {
    ...
    goal: 'أن ينطق الطالب أصوات الحروف بحركاتها الثلاث (بَ، بِ، بُ) وليس أسمائها (باء)',
    procedure: 'يدرب المعلم الطالب على النطق الصوتي الفوري للحرف وفق حركته (صوت الفتحة والكسرة والضمة) وتجنب نطق اسم الحرف الأبجدي.',
    skillId: 1,
    content: {
      gridItems: [
  ...
  // Page 7: Random Letters Pronunciation
  {
    ...
    goal: 'التحقق من الطلاقة الفونيمية ونطق أصوات الحروف بحركاتها بسرعة وخطف فوري.',
    procedure: 'نطق أصوات الحروف بحركاتها المتنوعة بشكل عشوائي وبسرعة دون نطق أسماء الحروف لتعزيز المسار الصوتي السريع.',
    skillId: 2,
    content: {
      gridItems: [
