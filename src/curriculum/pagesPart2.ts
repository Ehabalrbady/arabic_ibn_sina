...
export const PAGES_PART_2: BookPage[] = [
  ...
  // Page 59: Waw Madd Illustration
  {
    ...
    pageType: 'rule_explanation',
    goal: 'أن يتعرف التلميذ على صوت المد بالواو كصوت طويل ناشئ عن إطالة حركة الضمة (سُـ ➜ سُو)',
    procedure: 'يوضح المعلم للتلميذ أن الضمة صوت قصير (سُـ)، وعند إطالة الصوت ومطه ينشأ المد بالواو (سُو)، ولا يوضع أي تشكيل على واو المد.',
    skillId: 12,
    content: {
      text: 'المد بالواو هو إطالة صوت حركة الضمة بمقدار حركتين. الحرف الذي يسبق الواو يسمى (الحرف الممدود) ويشترط أن يكون مضموماً، وواو المد ساكنة مجردة من الحركة.',
      ruleBoxes: [
        { 
          title: 'التحليل الصوتي المقطعي لكلمة رَسُولُ', 
          body: 'تتكون الكلمة من ثلاثة أصوات: (رَ) صوت قصير بحركة الفتح، (سُو) مقطع مد بالواو صوت طويل ممدود، (لُ) صوت قصير بحركة الضم.', 
          example: 'رَ + سُو + لُ = رَسُولُ' 
        },
        { 
          title: 'قاعدة المد بالواو', 
          body: 'تأتي واو المد خالية من أية حركة أو سكون، والحرف الذي قبلها مضموم دائماً.', 
          example: 'يَقُولُ / نُورُ / صَابُونُ / عُصْفُورُ' 
        }
      ],
      analysisWords: [
        { word: 'رَسُولُ', syllables: ['رَ', 'سُو', 'لُ'], explanation: 'سُو: صوت طويل (مد بالواو)' },
        { word: 'يَقُولُ', syllables: ['يَ', 'قُو', 'لُ'], explanation: 'قُو: صوت طويل (مد بالواو)' },
        { word: 'نُورُ', syllables: ['نُو', 'رُ'], explanation: 'نُو: مقطع ممدود بالواو' }
      ]
    }
  },
